<template>
  <div class="w-full max-w-md mx-auto">
    <div class="text-center mb-8">
      <h2 class="text-3xl font-bold text-gray-900 mb-2">Join as Desk Seeker</h2>
      <p class="text-gray-600">Find and book your perfect workspace</p>
    </div>
...
import type { SeekerRegistrationData } from '~/types'
...
interface Emits {
  submit: [data: SeekerRegistrationData]
}
...
const form = ref<SeekerRegistrationData>({
  firstName: '',
  lastName: '',
  email: '',
  phone: '',
